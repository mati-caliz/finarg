...
public enum CurrencyType {
    ...
    AR_EUR_TARJETA("eur_tarjeta", "Euro Tarjeta", Country.ARGENTINA),
    AR_BRL_OFICIAL("brl_oficial", "Real Oficial", Country.ARGENTINA),
    AR_BRL_BLUE("brl_blue", "Real Blue", Country.ARGENTINA),
    AR_BRL_TARJETA("brl_tarjeta", "Real Tarjeta", Country.ARGENTINA),
    ...
    AR_CLP_TARJETA("clp_tarjeta", "Peso Chileno Tarjeta", Country.ARGENTINA),
    ...
    AR_UYU_TARJETA("uyu_tarjeta", "Peso Uruguayo Tarjeta", Country.ARGENTINA),
    AR_PYG_OFICIAL("pyg_oficial", "Guaraní Paraguayo Oficial", Country.ARGENTINA),
    AR_PYG_BLUE("pyg_blue", "Guaraní Paraguayo Blue", Country.ARGENTINA),
    AR_PYG_TARJETA("pyg_tarjeta", "Guaraní Paraguayo Tarjeta", Country.ARGENTINA),
    AR_BOB_OFICIAL("bob_oficial", "Boliviano Oficial", Country.ARGENTINA),
    AR_BOB_BLUE("bob_blue", "Boliviano Blue", Country.ARGENTINA),
    AR_BOB_TARJETA("bob_tarjeta", "Boliviano Tarjeta", Country.ARGENTINA),
    AR_CNY_OFICIAL("cny_oficial", "Yuan Oficial", Country.ARGENTINA),
    AR_CNY_BLUE("cny_blue", "Yuan Blue", Country.ARGENTINA),
    AR_CNY_TARJETA("cny_tarjeta", "Yuan Tarjeta", Country.ARGENTINA),
