export const translations = {
  es: {
    ...
    bandsDisclaimerText: 'Los valores de las bandas son indicativos y pueden cambiar según las políticas del BCRA. Las bandas se ajustan mensualmente según el crawling peg.',
  ...
  pt: {
    ...
    bandsDisclaimerText: 'Os valores das bandas são indicativos e podem mudar de acordo com as políticas do BCRA. As bandas são ajustadas mensalmente de acordo com o crawling peg.',
  ...
  en: {
    ...
    bandsDisclaimerText: 'Band values are indicative and may change according to BCRA policies. Bands are adjusted monthly according to the crawling peg.',
