...
export const COUNTRIES: Record<CountryCode, CountryConfig> = {
  ar: {
    ...
    currencyTypes: [
      ...
      { code: 'pyg_oficial', name: 'Guaraní Paraguayo Oficial', isOfficial: true, isParallel: false },
      { code: 'pyg_blue', name: 'Guaraní Paraguayo Blue', isOfficial: false, isParallel: true },
      { code: 'pyg_tarjeta', name: 'Guaraní Paraguayo Tarjeta', isOfficial: false, isParallel: false },
      { code: 'bob_oficial', name: 'Boliviano Oficial', isOfficial: true, isParallel: false },
      { code: 'bob_blue', name: 'Boliviano Blue', isOfficial: false, isParallel: true },
      { code: 'bob_tarjeta', name: 'Boliviano Tarjeta', isOfficial: false, isParallel: false },
