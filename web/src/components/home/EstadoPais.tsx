...
const HERO_CODE = "ipc_mensual";
const HERO_SOURCE = "argentinadatos";
const HERO_POINTS = 24;
const TILE_CODES = ["dolar_oficial", "riesgo_pais", "reservas_internacionales", "desempleo"];
