...
export const FEATURED_INDICATORS: IndicatorDisplay[] = [
  {
    ...
    label: "Dólar oficial",
    unit: "ARS",
    href: "/indicator/dollar_official",
    goodWhen: "down",
  ...
  },
  {
    ...
    unit: "USD M",
    href: "/indicator/international_reserves",
    goodWhen: "up",
  ...
  },
  {
    ...
    label: "Pobreza",
    unit: "%",
    href: "/indicator/poverty_persons",
    goodWhen: "down",
  ...
  },
  {
    ...
    unit: "pts",
    href: "/indicator/government_confidence",
    goodWhen: "up",
