export const translations = {
  es: {
    ...
    errorLoadingHolidays: "Error al cargar feriados",
    verifyBackendRunning: "Verificá que el backend esté corriendo",
    noUpcomingHolidays: "No hay feriados próximos",
    advancedHistoricalData: "Datos históricos avanzados",
    googleLoginError: "Error al iniciar sesión con Google.",
    incomeTaxCalculatorFeature: "Calculadora de Sueldo Neto",
    compoundInterestFeature: "Calculadora de Interés Compuesto",
    installmentsVsCashSubtitle: "Calculá qué te conviene más",
    popular: "Popular",
    upgradeToPremium: "Actualizá a Premium",
    premiumFeatures: "Cálculos ilimitados + Alertas + Sin ads",
    day: "día",
    tnaRate: "Tasa TNA",
    minimum: "Mínima",
    maximum: "Máxima",
    ...
    newsOfficialBadge: "Oficial",
    newsAiSummary: "Resumen IA",
    newsKeyPoints: "Puntos clave",
    ...
    holidaysLoadError: "Error al cargar los feriados. Por favor, intentá nuevamente más tarde.",
    holidaysNoneAvailable: "No hay feriados disponibles para este año",
    holidaysToday: "¡Hoy!",
    holidaysTomorrow: "Mañana",
    holidaysDaysUntil: "Faltan {days} días",
    holidaysSummary: "Resumen {year}",
    holidaysNational: "Feriados nacionales",
    holidaysUpcoming: "Próximos feriados",
    holidaysMonthsWithHolidays: "Meses con feriados",

    feedbackSubmitError: "Hubo un error al enviar tu feedback. Por favor, intentá de nuevo.",
    feedbackAriaLabel: "Enviar feedback",
    feedbackButtonText: "¿Qué te parece?",
    feedbackCloseAriaLabel: "Cerrar",
    feedbackThankYou: "¡Gracias!",
    feedbackTitle: "Tu opinión nos ayuda",
    feedbackSubmittedMessage: "Tu feedback fue enviado correctamente",
    feedbackRatingQuestion: "¿Cómo calificarías tu experiencia?",
    feedbackStarsAriaLabel: "{stars} estrellas",
    feedbackCommentLabel: "¿Qué podemos mejorar? (opcional)",
    feedbackCommentPlaceholder: "Contanos qué te gustaría que mejoremos...",
    feedbackEmailLabel: "Email (opcional, por si queremos contactarte)",
    feedbackSubmitting: "Enviando...",
    feedbackSubmitButton: "Enviar feedback",
    feedbackLater: "Más tarde",

    paywallHistoricalDescription:
      "Para ver datos de más de 2 años necesitás Premium. Accedé a gráficos históricos completos de hasta 10 años.",
  },
  pt: {
    dashboard: "Dashboard",
    quotes: "Cotações",
    ...
    errorLoadingHolidays: "Erro ao carregar feriados",
    verifyBackendRunning: "Verifique se o backend está funcionando",
    noUpcomingHolidays: "Sem feriados próximos",
    advancedHistoricalData: "Dados históricos avançados",
    googleLoginError: "Erro ao iniciar sessão com Google.",
    incomeTaxCalculatorFeature: "Calculadora de Salário Líquido",
    compoundInterestFeature: "Calculadora de Juros Compostos",
    installmentsVsCashSubtitle: "Calcule o que é melhor para você",
    popular: "Popular",
    upgradeToPremium: "Atualize para Premium",
    premiumFeatures: "Cálculos ilimitados + Alertas + Sem anúncios",
    ...
    newsOfficialBadge: "Oficial",
    newsAiSummary: "Resumo IA",
    newsKeyPoints: "Pontos-chave",
    ...
    holidaysLoadError: "Erro ao carregar feriados. Por favor, tente novamente mais tarde.",
    holidaysNoneAvailable: "Não há feriados disponíveis para este ano",
    holidaysToday: "Hoje!",
    holidaysTomorrow: "Amanhã",
    holidaysDaysUntil: "Faltam {days} dias",
    holidaysSummary: "Resumo {year}",
    holidaysNational: "Feriados nacionais",
    holidaysUpcoming: "Próximos feriados",
    holidaysMonthsWithHolidays: "Meses com feriados",

    feedbackSubmitError: "Houve um erro ao enviar seu feedback. Por favor, tente novamente.",
    feedbackAriaLabel: "Enviar feedback",
    feedbackButtonText: "O que você acha?",
    feedbackCloseAriaLabel: "Fechar",
    feedbackThankYou: "Obrigado!",
    feedbackTitle: "Sua opinião nos ajuda",
    feedbackSubmittedMessage: "Seu feedback foi enviado com sucesso",
    feedbackRatingQuestion: "Como você avaliaria sua experiência?",
    feedbackStarsAriaLabel: "{stars} estrelas",
    feedbackCommentLabel: "O que podemos melhorar? (opcional)",
    feedbackCommentPlaceholder: "Conte-nos o que gostaria que melhorássemos...",
    feedbackEmailLabel: "Email (opcional, caso queiramos entrar em contato)",
    feedbackSubmitting: "Enviando...",
    feedbackSubmitButton: "Enviar feedback",
    feedbackLater: "Mais tarde",

    paywallHistoricalDescription:
      "Para ver dados de mais de 2 anos, você precisa do Premium. Acesse gráficos históricos completos de até 10 anos.",
  },
  en: {
    dashboard: "Dashboard",
    quotes: "Quotes",
    ...
    errorLoadingHolidays: "Error loading holidays",
    verifyBackendRunning: "Verify the backend is running",
    noUpcomingHolidays: "No upcoming holidays",
    advancedHistoricalData: "Advanced historical data",
    googleLoginError: "Error logging in with Google.",
    incomeTaxCalculatorFeature: "Net Salary Calculator",
    compoundInterestFeature: "Compound Interest Calculator",
    installmentsVsCashSubtitle: "Calculate what's best for you",
    popular: "Popular",
    upgradeToPremium: "Upgrade to Premium",
    premiumFeatures: "Unlimited calculations + Alerts + No ads",
    ...
    newsOfficialBadge: "Official",
    newsAiSummary: "AI Summary",
    newsKeyPoints: "Key points",
    ...
    holidaysLoadError: "Error loading holidays. Please try again later.",
    holidaysNoneAvailable: "No holidays available for this year",
    holidaysToday: "Today!",
    holidaysTomorrow: "Tomorrow",
    holidaysDaysUntil: "{days} days left",
    holidaysSummary: "Summary {year}",
    holidaysNational: "National holidays",
    holidaysUpcoming: "Upcoming holidays",
    holidaysMonthsWithHolidays: "Months with holidays",

    feedbackSubmitError: "There was an error submitting your feedback. Please try again.",
    feedbackAriaLabel: "Send feedback",
    feedbackButtonText: "What do you think?",
    feedbackCloseAriaLabel: "Close",
    feedbackThankYou: "Thank you!",
    feedbackTitle: "Your opinion helps us",
    feedbackSubmittedMessage: "Your feedback was sent successfully",
    feedbackRatingQuestion: "How would you rate your experience?",
    feedbackStarsAriaLabel: "{stars} stars",
    feedbackCommentLabel: "What can we improve? (optional)",
    feedbackCommentPlaceholder: "Tell us what you'd like us to improve...",
    feedbackEmailLabel: "Email (optional, in case we want to reach out)",
    feedbackSubmitting: "Sending...",
    feedbackSubmitButton: "Send feedback",
    feedbackLater: "Later",

    paywallHistoricalDescription:
      "To view data beyond 2 years you need Premium. Access complete historical charts up to 10 years.",
  },
};
